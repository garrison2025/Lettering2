...
export function MetaTags({
  ...
  image = "https://generador-lettering.pages.dev/og-image.png",
  type = "website",
  locale = "es_ES",
  twitterCard = "summary_large_image",
  canonicalUrl,
}: MetaTagsProps) {
  const fullUrl = url.startsWith("http") ? url : `https://generador-lettering.pages.dev${url}`
  const fullImage = image.startsWith("http") ? image : `https://generador-lettering.pages.dev${image}`
